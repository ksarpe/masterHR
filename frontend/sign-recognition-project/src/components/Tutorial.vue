<template>
  <div class="fixed inset-0 bg-black bg-opacity-85 flex justify-center items-center text-gray-800 p-4">
    <div class="bg-white p-5 rounded-lg text-center border-blue-500 border-4 max-w-full md:max-w-2xl">
      ...
      <div class="text-lg md:text-2xl font-medium">
        ...
        <p class="font-semibold">
          <span class="text-red-400 font-semibold">Kliknij myszką (bądź palcem) na przycisk pod Twoją kamerą</span
          >, a po dwóch sekundach zostanie zrobione zdjęcie.
        </p>
        <p class="font-semibold">
          bądź po prostu <span class="text-red-400 font-semibold">naciśnij enter (tylko na PC)</span>, a również
