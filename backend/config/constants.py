...
DATASET_PATH2 = os.path.join(BACKEND_DIR, 'model/point_recognizer', 'points2.csv') # Path to the dataset (created by dev_app.py) 
...
TFLITE_SAVE_PATH2 = os.path.join(BACKEND_DIR, 'model/point_recognizer', 'point_recognizer2.tflite') # Path to save the test tflite model for chapter 2
...
LABELS_PATH2 = os.path.join(BACKEND_DIR, 'model/point_recognizer', 'point_recognizer_labels2.csv') # Path to save the labels
...
NUM_CLASSES = 21 # number of labels
