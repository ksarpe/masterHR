...
X_dataset = np.loadtxt(DATASET_PATH, delimiter=',', dtype='float32', usecols=list(range(1, (21 * 2) + 1))) # we got coordinates of 21 points
...
model.save(MODEL_CP_SAVE_PATH, include_optimizer=False)
